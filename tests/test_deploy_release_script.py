...
SCRIPT = ROOT / "scripts" / "deploy_v220.sh"


class DeployV220ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_release_and_stage_are_exact(self):
        self.assertIn('release_version="2.2.0"', self.source)
        self.assertIn('stage_namespace="/tmp/mediabot-v220-"', self.source)
    ...
    def test_guild_scope_uid_migration_and_write_probe_are_mandatory(self):
        ...
        self.assertIn(".mediabot-write-probe-v220", self.source)
        self.assertIn(
